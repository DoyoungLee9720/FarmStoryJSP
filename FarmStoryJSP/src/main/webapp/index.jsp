...
<head>
    ...
    <style>
        * {
        ...
        .banner_images1 {
            background-image: url('/images/main_banner_sub1_bg.jpg');
            
        }
        .banner_images2 {
            background-image: url('/images/main_banner_sub2_bg.jpg');
...
<%@ include file="/FarmStoryJSP/css/_header.jsp"%>
    <main>
        <section class="Farmstory">
            <div class="benner1">
                    <img src="/images/main_slide_img_tit.png" alt="메인 이미지">
                <div>
                    <img src="/images/main_banner_img.png" alt="배너 사과">
                    <img src="/images/main_banner_tit.png" alt="오픈기념">
                    <img src="/images/main_banner_txt.png" alt="그랜드오픈">
                </div>
            </div>
           </section>
           <section class="bestitem">
            <div><img src="/images/main_market_tit.png" alt="베스트 상품"> </div>
            <div>
            <a href="#">
                <article>
        ...
        <section class="section-haeder">
            <div class="div-header">
                <div class="banner_images1">
                    <tr>
                        <img src="/images/main_banner_sub1_tit.png">
                    </tr>
                </div>
                <div class="banner_images2">
                    <tr>
                        <img src="/images/main_banner_sub2_tit.png">
                    </tr>
                </div>
            </div>
        </section>
        <section class="section-main">
            <article class="article-main">
                <div class="container">
                    <img class="conimg" src="/images/main_latest1_tit.png">
                    <div class="content">
                ...
                <div class="container">
                    ...
                    <div class="content">
                        <img src="/images/main_latest2_img.jpg" alt="텃밭가꾸기">
                        <table>
                            <tbody>
                                <tr>
                                    <td><a href="#" class="link">> 토마토! 건강하게 길러...</a></td>
                ...
                <div class="container">
                    <img class="conimg" src="/images/main_latest1_tit.png">
                    <div class="content">
                        <img src="/images/main_latest3_img.jpg" alt="텃밭가꾸기">
                        <table>
                            <tbody>
                                <tr>
                                    <td><a href="#" class="link">> 토마토! 건강하게 길러...</a></td>
        ...
        <section class="content-customer">
            <article class="customer-box">
                <div class="customer">
                    <table>
                        <tr>
                            <td colspan="3" class="cus">
                                <img class="tit.png" src="/images/main_sub2_cs_tit.png" alt="고객센터">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <img class="img.png" src="/images/main_sub2_cs_img.png" alt="고객센터">
                            </td>
                            <td>
                                <img class="txt.png" src="/images/main_sub2_cs_txt.png" alt="고객센터">
                            </td>
                            <td>
                ...
                <div class="account">
                    <div class="img">
                        <tr>
                            <td>
                                <img src="/images/main_sub2_account_tit.png" alt="계좌 안내">
                            </td>
                        </tr>
                    </div>
                    <div class="accountUl">
                ...
                <div class="ment">
                    <div class="mt">
                        <div class="ment-img">
                            <td>
                                <img src="/images/main_sub2_notice_tit.png" alt="공지상황">
                            </td>
                        </div>
                    </div>
                    <table>
